...
import type {ITicketingConfig} from '../interfaces/ITicketingConfig.ts';
...
export const queries = {
    sprintIssues: (sprintId: string, jiraConfig: ITicketingConfig) => `
  ...
  `,
    ...
    customDateRange: (dateRange: string, jiraConfig: ITicketingConfig) => {
        try {
